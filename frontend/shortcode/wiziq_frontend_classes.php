			...
			<div class="wiziq_right" >
				...
				<table class="list_courses" id="list_courses" >
					...
					if( $view_classes_permission && $result ){
						...
						echo '<tr><td colspan="8">'.__('You do not have permission to access this class','wiziq').'</td></tr>';
					}
					else {
						...
						<table>
							...
							<tr>
								...
								<td>
									...
									<div id= "class_duration_ms" ><?php _e( 'Minimun 30 min and maximum 300 min' , 'wiziq' );?> </div>
		...
		*/ 
		...
		?>
			<table class = "form-table" >
				...
				<div class= "frontend_buttons courses_detail_buttons" >
					<?php 
					/*
