 ...
 jQuery(document).ready(function(){
	...
	jQuery('#wiziq-add-user').click(function () {
		...
		jQuery.map(jQuery('#wiziq-all-user').find("option:selected"),function(option, i) {
			permission_string += '<tr id=enroll_'+jQuery(option).val()+'>';
			permission_string += '<td><input type="hidden" name="user_id[]" value="'+jQuery(option).val()+'" />'+jQuery(option).text() +'</td>';
			permission_string += '<td><input type="hidden" value="0" name="create_class['+jQuery(option).val()+']" /><input value="1" type="checkbox" name="create_class['+jQuery(option).val()+']" class="create_class" id="create_class_'+jQuery(option).val()+'" /> </td>'; 
			permission_string += '<td><input type="hidden" value="0" name="view_recording['+jQuery(option).val()+']" /><input value="1" type="checkbox"  name="view_recording['+jQuery(option).val()+']" class="view_recording" checked = "checked" /> </td>';
			permission_string += '<td><input type="hidden" value="0" name="download_recording['+jQuery(option).val()+']" /><input value="1" type="checkbox" name="download_recording['+jQuery(option).val()+']" class="download_recording"/> </td>';
			permission_string += '<td><input type="hidden" value="0" name="upload_content['+jQuery(option).val()+']" /><input value="1" type="checkbox"  name="upload_content['+jQuery(option).val()+']" class="upload_content" id="'+jQuery(option).val()+'"/> </td>';
